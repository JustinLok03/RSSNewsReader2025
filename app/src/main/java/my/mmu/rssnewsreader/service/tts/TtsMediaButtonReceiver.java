 ...
 * <pre>
 * &lt;service android:name="my.mmu.android.MediaPlaybackService" &gt;
 *   &lt;intent-filter&gt;
 *     &lt;action android:name="android.intent.action.MEDIA_BUTTON" /&gt;
 *   &lt;/intent-filter&gt;
 * &lt;/service&gt;
 ...
 * {@link androidx.media.session.MediaButtonReceiver#handleIntent(MediaSessionCompat, Intent)}, passing in your current
